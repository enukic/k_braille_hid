...
#define DEVICE_NAME                         "braille display"                          /**< Name of device. Will be included in the advertising data. */
...
#define OUTPUT_REPORT_MAX_LEN               20                                          /**< Maximum length of Output Report. */
...
#define LALT_KEY_CODE                       0x04                                       /**< Key code indicating the press of the Shift Key. */
...
static void gap_params_init(void)
{
    ...
    err_code = sd_ble_gap_appearance_set(HID_BRAILLE_DISPLAY);
    APP_ERROR_CHECK(err_code);
...
static void hids_init(void)
{
    ...
    static uint8_t                     report_map_data[] =
    {
        ...
        0x95, 0x01, // Report Count (1)
        0x81, 0x03, // Input (Const,Var,Abs,No Wrap,Linear,Preferred State,No Null Position) //2 bit pad
        0x05, 0x41, // Usage Page (Braille)
        ...
        0x75, 0x04, // Report Size (4)
        0x95, 0x01, // Report Count (1)
        0x81, 0x03, // Input (Const,Var,Abs,No Wrap,Linear,Preferred State,No Null Position) //4‐bit pad
        0xC0, // End Collection
        0xC0, // End Collection
        0xC0, // End Collection
    };
                                            ...
                                            uint16_t   * p_actual_len)
{
    ...
    do
    {
        ...
        //}
        data[MODIFIER_KEY_POS] |= LALT_KEY_CODE;
...
uint8_t key_left    = 0x50;
uint8_t key_right   = 0x4f;
uint8_t key_bspace  = 0x2a;
uint8_t key_enter   = 0x28;
